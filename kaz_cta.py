...
t1 = Transliterator("kaz", Script.LATIN, Script.COMMON_TURKIC)
t2 = Transliterator("kaz", Script.CYRILLIC, Script.COMMON_TURKIC)
...
file_path = "rawwikitxt/kk_20260101.txt"
print(file_path)
linecount = 0
...
with open("uroman_kk.txt", 'w', encoding='utf-8') as uromanf:
    for each_pureroman in pure_uroman_list:
        uromanf.write(' '.join(tokenize(each_pureroman))+'\n')

with open("comturk_kk.txt", 'w', encoding='utf-8') as comturkf:
