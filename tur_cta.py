...
t1 = Transliterator("tur", Script.LATIN, Script.COMMON_TURKIC)
...
file_path = "rawwikitxt/tr_20260101.txt"
print(file_path)
linecount = 0
...
with open("uroman_tr.txt", 'w', encoding='utf-8') as uromanf:
    for each_pureroman in pure_uroman_list:
        uromanf.write(' '.join(tokenize(each_pureroman))+'\n')

with open("comturk_tr.txt", 'w', encoding='utf-8') as comturkf:
