...
t2 = Transliterator("bak", Script.CYRILLIC, Script.COMMON_TURKIC)
...
file_path = "rawwikitxt/ba_20260101.txt"
print(file_path)
linecount = 0
...
with open("uroman_ba.txt", 'w', encoding='utf-8') as uromanf:
    for each_pureroman in pure_uroman_list:
        uromanf.write(' '.join(tokenize(each_pureroman))+'\n')

with open("comturk_ba.txt", 'w', encoding='utf-8') as comturkf:
