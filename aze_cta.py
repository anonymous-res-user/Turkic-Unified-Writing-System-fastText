...
t1 = Transliterator("aze", Script.LATIN, Script.COMMON_TURKIC)
t2 = Transliterator("aze", Script.CYRILLIC, Script.COMMON_TURKIC)
t3 = Transliterator("azb", Script.PERSO_ARABIC, Script.COMMON_TURKIC)
t4 = Transliterator("uig", Script.PERSO_ARABIC, Script.COMMON_TURKIC)

file_path = "rawwikitxt/az_20260101.txt"
print(file_path)
linecount = 0
...
with open("uroman_az.txt", 'w', encoding='utf-8') as uromanf:
    for each_pureroman in pure_uroman_list:
        uromanf.write(' '.join(tokenize(each_pureroman))+'\n')

with open("comturk_az.txt", 'w', encoding='utf-8') as comturkf:
