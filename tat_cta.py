...
t1 = Transliterator("tat", Script.LATIN, Script.COMMON_TURKIC)
t2 = Transliterator("tat", Script.CYRILLIC, Script.COMMON_TURKIC)
...
file_path = "rawwikitxt/tt_20260101.txt"
print(file_path)
linecount = 0
...
with open("uroman_tt.txt", 'w', encoding='utf-8') as uromanf:
    for each_pureroman in pure_uroman_list:
        uromanf.write(' '.join(tokenize(each_pureroman))+'\n')

with open("comturk_tt.txt", 'w', encoding='utf-8') as comturkf:
