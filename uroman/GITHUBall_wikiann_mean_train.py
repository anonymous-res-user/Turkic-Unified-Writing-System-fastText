...
base_dir = Path("PATH/uniturkic0804/uroman") #change to your path

wikiann_data_dir = base_dir / "wikiann_task"

fasttext_model_path = (
    base_dir / "turkic_uroman.bin"
)
...
random_seed =  #from 1,41,42,43,72
