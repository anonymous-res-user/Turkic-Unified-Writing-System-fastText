...
For training the CTS WikiANN NER model, please run `GITHUBall_wikiann_mean_train.py`. Hyperparameters are all in this script.
For training the CTS UD POS model, please run `GITHUBall_pos_train.py`. Hyperparameters are all in this script.
