...
t2 = Transliterator("kir", Script.CYRILLIC, Script.COMMON_TURKIC)
...
file_path = "rawwikitxt/ky_20260101.txt"
print(file_path)
linecount = 0
...
with open("uroman_ky.txt", 'w', encoding='utf-8') as uromanf:
    for each_pureroman in pure_uroman_list:
        uromanf.write(' '.join(tokenize(each_pureroman))+'\n')

with open("comturk_ky.txt", 'w', encoding='utf-8') as comturkf:
