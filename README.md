...
you can get the line concatenation without punctuation cleaning version and the line concatenation with punctuation cleaning version text files of each uroman\_{iso639-1}.txt (keep the *uroman* string in line 6 and line 221) or comturk\_{iso639-1}.txt (change the *uroman* string in line 6 and line 221 to *comturk*)
